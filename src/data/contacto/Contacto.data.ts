...
export const DataContactoInversores: ItemContactoProps[] = [
  {
...
export const DataContactoCorporativos: ItemContactoProps[] = [
  {
  ...
  },
  {
    title: 'Operaciones',
    numberTelf: '044 75 78 92',
    numberCel: '+51 942 808 592',
    correo: 'operaciones@ecreea.com'
  },
  {
    title: 'Servicios',
...
export const DataContactoTalento: ItemContactoProps[] = [
  {
    title: 'Gestión del Talento Humano',
    numberCel: '+51 947 377 239',
    correo: 'gdh@ecreea.com'
  }
]
