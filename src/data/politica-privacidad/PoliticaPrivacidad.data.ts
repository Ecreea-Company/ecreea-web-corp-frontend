...
export const DataPrivacidad: ItemDropdownsProps[] = [
  ...
  },
  {
    ...
    data: 'El responsable del tratamiento de tus datos es:\n\n• ECREEA COMPANY, S.A. (Ecreea, S.A), sociedad peruana que actúa como matriz del Grupo Ecreea company. (en adelante, "Ecreea"): o Correo electrónico de la delegada de Protección de Datos:\n\n@ecreea.com\n\nEn otras palabras, ECREEA COMPANY (en adelante, “Nosotros”), es el responsable del tratamiento. Esto quiere decir que nos hacemos cargo de tratar y proteger tus datos personales.'
  },
  {
  ...
  {
    title: '¿Compartiremos tus datos con terceros?',
    data: 'Para cumplir las finalidades indicadas en la presente Política de Privacidad, es necesario que demos acceso a tus datos personales a entidades del Grupo Ecreea (por ejemplo la e-commerce E2B de la entidad/es del Grupo Ecreea ubicada/s en el mercado al que te hayas referido en tu consulta) y a terceras partes que nos presten apoyo en los servicios que te ofrecemos, a saber:\n\n• Proveedores de servicios tecnológicos,\n\n• Proveedores de servicios relacionados con atención al cliente. Por eficiencia del servicio, algunos de los prestadores mencionados están ubicados en territorios situados fuera del Espacio Económico Europeo que no proporcionen un nivel de protección de datos equiparable al de la Unión Europea, como Estados Unidos. En tales casos, te informamos de que transferimos tus datos con garantías adecuadas y siempre guardando la seguridad de tus datos:\n\n• Algunos proveedores están certificados en ... , certificación que puedes consultar en el siguiente enlace https://www.privacyshield.gov/welcome\n\n• Con otros proveedores hemos firmado Cláusulas Contractuales Tipo aprobadas por la Comisión, cuyo contenido puedes consultar en el siguiente enlace: ...'
  },
  {
    title: '¿Cuáles son tus derechos cuando nos facilita tus datos?',
    data: 'Nos comprometemos a respetar la confidencialidad de tus datos personales y a garantizarte el ejercicio de tus derechos. Puedes ejercitarlos sin coste alguno escribiéndonos un correo electrónico a nuestra dirección @ecreea.com, simplemente indicándonos el motivo de tu solicitud y el derecho que quieres ejercitar. En caso de que lo consideremos necesario para poder identificarte, podremos solicitarte copia de un documento acreditativo de tu identidad.\n\nEn particular, independientemente de la finalidad o la base legal en virtud de la que tratemos tus datos, tienes derecho a:\n\n• Pedirnos acceso a los datos de los que disponemos de ti.\n\n• Pedirnos que rectifiquemos los datos de los que ya disponemos. De todas formas, ten en cuenta que, al facilitarnos activamente tus datos personales por cualquier vía, garantizas que son ciertos y exactos y te comprometes a notificarnos cualquier cambio o modificación de estos. Cualquier pérdida o daño causado a la Plataforma o al responsable de la Plataforma o a cualquier tercero por motivo de una comunicación de información errónea, inexacta o incompleta en los formularios de registro, será responsabilidad exclusiva del usuario. Por favor, recuerda que por regla general solo debes facilitarnos tus propios datos personales, no los de terceros.\n\n• Pedirnos que suprimamos tus datos en la medida en que ya no sean necesarios para la finalidad para los que necesitemos tratarlos según te hemos informado más arriba, o en que ya no contemos con legitimación para hacerlo.\n\n• Pedirnos que limitemos el tratamiento de tus datos, lo que supone que en determinados casos puedas solicitarnos que suspendamos temporalmente el tratamiento de los datos o que los conservemos más allá del tiempo necesario cuando puedas necesitarlo. Adicionalmente, cuando el tratamiento de tus datos esté basado en nuestro interés legítimo, también tendrás derecho a oponerte al tratamiento de tus datos.\n\nPor último, te informamos de tu derecho a presentar una reclamación ante la autoridad de control en materia de protección de datos pertinente, en particular, ante la Agencia Española(peruana) de Protección de Datos (https://www.agpd.es/portalwebAGPD/index-ides-idphp.php).'
  },
  {
