  ...
  return (
    <Public titlePage="Artistas">
      <div className={styles.Page}>
        ...
        <section className={styles.Holiver}>
          <p>
            “Somos artistas que crean valor en la vida de nuestros usuarios,
            trabajamos en mas que una empresa, trabajamos en equipo, trabajamos
            en arte, trabajamos para ecreear un mundo mejor.”
          </p>
          <span>Holiver U.</span>
        </section>
        <section className={styles.Letrero}>
          <Image
            layout="responsive"
            width={1920}
            height={1080}
            src="/pages/artistas/art_2.png"
          />
        </section>
        <section className={styles.Carlos}>
          <p>
